...
public interface IUserApi
{
    ...
    public Task LogOut();
    public Task ResendEmailConfirmationUrl(ResendEmailConfirmationUrlParameters parameters);
...
public class UserApi : IUserApi
{
    ...
    {
        var result = await _http.PutAsJsonAsync("api/user/resend-email-confirmation-url", parameters);
